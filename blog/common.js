...
function readFile(){
    var parser=new DOMParser();
     var fso=parser.parseFromString(html,"data/xml");
...
function numCapicua(numero){
    ...
    return parseInt(inv.toString().replace(/,/g, ""));
}
...
function datosNumeros(){
    ...
    var desC = descomposicion(numero).toString().replace(/,/g, " * ");
    if(primo(numero) == 0){
        pr = "El número es compuesto" + " ("+ numero + " = " + desC + ") ";
    }else if(primo(numero) == 1){
        pr = "El número es primo" + " (" + numero + " = " + desC + ") ";
    }else{
    ...
    if(numero>=0){
        bin = "Número en binario: " + binario(numero).replace(/,/g, "");
    }else{
        bin = "No tiene representación binaria (sin base)"
    }
...
function imgSiguiente(){
    ...
    if(img == 1){
        ...
        imagenGaleria.src = "imagenes/iGaleria/paisaje34.jpg";
        img = 5;
    }else if(img ==5){
        imagenGaleria.src = "imagenes/iGaleria/paisaje36.jpg";
        img = 6;
    }else{
